...
public class KuisIPA extends AppCompatActivity{
    private Database db;
    ...
    private void setUpWaktu() {
        mCountDownTimer = new CountDownTimer(detik, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(KuisIPA.this, "Waktu Habis", Toast.LENGTH_SHORT).show();
            }
        };
    ...
    private OnClickListener klikSelesai = new OnClickListener() {
        public void onClick(View v) {
            ...
            tampilKotakAlert = new AlertDialog.Builder(KuisIPA.this).create();
            tampilKotakAlert.setTitle("Nilai");
            tampilKotakAlert.setMessage("Benar " + jumlahJawabanYgBenar + " dari "
                    + (listSoal.size() + " soal" + " Total Score = " + totalScore));
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "Lagi",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            KuisIPA.this.tunjukanPertanyaan(0,
                                    cekPertanyaan);
                        }
                    });
