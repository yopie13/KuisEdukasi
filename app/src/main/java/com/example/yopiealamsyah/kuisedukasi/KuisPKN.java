 ...
 */
public class KuisPKN extends AppCompatActivity{
    private Database db;
    ...
    private void tunjukanPertanyaan(int urutan_soal_soal, boolean review) {
        try {
            rg.clearCheck();
            Soal soal = new Soal();
            soal = listSoal3.get(urutan_soal_soal);
            ...
            if (urutan_soal_soal == (listSoal3.size() - 1))
    ...
    private void setUpWaktu() {
        mCountDownTimer = new CountDownTimer(detik, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(KuisPKN.this, "Waktu Habis", Toast.LENGTH_SHORT).show();
            }
        };
    ...
    private View.OnClickListener klikSelesai = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            tampilKotakAlert = new AlertDialog.Builder(KuisPKN.this).create();
            tampilKotakAlert.setTitle("Nilai");
            tampilKotakAlert.setMessage("Benar " + jumlahJawabanYgBenar + " dari "
                    + (listSoal3.size() + " soal" + " Total Score = " + totalScore));
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "Lagi",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            KuisPKN.this.tunjukanPertanyaan(0,
                                    cekPertanyaan);
                        }
                    });
    ...
    private View.OnClickListener klikBerikut = new View.OnClickListener() {
        public void onClick(View v) {
            aturJawaban_nya();
            urutanPertanyaan++;
            if (urutanPertanyaan >= listSoal3.size())
                urutanPertanyaan = listSoal3.size() - 1;
